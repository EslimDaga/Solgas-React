          ...
          <div className="form-form-wrap">
            <div className="form-container">
              <div className="form-content">
                ...
                <p className="terms-conditions">© 2020 Todos los derechos Reservados. <a href="https://solgas.com.pe">Solgas</a> es un producto de <a href="https://segursat.com">Segursat</a>. <a href="/login">Preferencias de cookies </a>.</p>
              </div>
            </div>
          </div>
        </div>
