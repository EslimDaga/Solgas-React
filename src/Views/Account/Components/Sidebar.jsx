      ...
      <div className="sidebar-wrapper sidebar-theme">
        <nav id="compactSidebar">
          <ul className="menu-categories">
            <li className="menu">
              <a href="/dashboard" data-active="false" className="menu-toggle">
            ...
            <li className="menu">
              <a href="/events" data-active="false" className="menu-toggle">
                <div className="base-menu">
                  <div className="base-icons">
            ...
            <li className="menu">
              <a href="/history" data-active="false" className="menu-toggle">
                <div className="base-menu">
                  <div className="base-icons">
            ...
            <li className="menu">
              <a href="/checkpoint" data-active="false" className="menu-toggle">
                <div className="base-menu">
                  <div className="base-icons">
            ...
            <li className="menu">
              <a href="/drivers" data-active="false" className="menu-toggle">
                <div className="base-menu">
                  <div className="base-icons">
            ...
            <li className="menu">
              <a href="/units" data-active="false" className="menu-toggle">
                <div className="base-menu">
                  <div className="base-icons">
