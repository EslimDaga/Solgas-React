    ...
    var colorPallet = {
        createPallet: function() {
            $cPalletHTMl = '<aside id="colorPallet" class="color-pallet">'+
                                ...
                                '</div>'+
                                '<div class="p-colors">'+
                                    '<div id="default" class="color-scheme-default colorPallet-tooltip" data-original-title="Por defecto"></div>'+
                                    '<div id="minimal" class="color-scheme-minimal colorPallet-tooltip" data-original-title="Minimalista"></div>'+
                                '</div>'+
                            '</aside>';
